...
- `ironmouse_4h/` (4.01 h, 17,473 chat comments) has already been used for Phase 1
  validation — ROADMAP.md's Phase 1 status cites it, and
  `detection/scripts/ironmouse-run.ts` reads it by path.
